...
$(document).ready(function(){
	...
	$('#form1').submit(function(){
		...
		query = $('#q1').val();
		url = "http://www.google.com.hk/cse?cx=partner-pub-7317279072506010:1880743572&ie=UTF-8&q="+query+"&sa=Search#gsc.tab=0&gsc.q="+query+"&gsc.page=1";
		faction = $('#form1').attr('action');
		
		if(faction.search("google") != -1)
		{
			window.location = url;
			return false;
		}
